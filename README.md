...
```javascript
iterrange = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-iter-range@v0.2.1-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/stats-iter-range/actions/workflows/test.yml/badge.svg?branch=v0.2.1
[test-url]: https://github.com/stdlib-js/stats-iter-range/actions/workflows/test.yml?query=branch:v0.2.1
